$(document).ready(function() {
    ...
    const ENABLE_ADDING_MAP_AREA = false;
    ...
    //-----------------------------------------------------------------------------
    // Provision for drawing rectangles on a part of the map to highlight it
    //-----------------------------------------------------------------------------

    if (ENABLE_ADDING_MAP_AREA) {
        ...
        function add_coordinates_handler(e) {
            ...
            console.log(JSON.stringify(new_area, null, 4));
        }    
        ...
        $(document).on('mousemove', MAP_PARENT_AREA, mouseMoveHandler);

        // mouse down event function in area div
        $(document).on('mousedown', MAP_PARENT_AREA, mouseDownHandler);

        // mouse up event function in area div
        $(document).on('mouseup', MAP_PARENT_AREA, mouseUpHandler);
        ...
        $(MAP_PARENT_AREA).hover(function(){
            $(this).toggleClass('area_cursor');
        });
